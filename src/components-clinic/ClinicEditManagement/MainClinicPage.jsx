...
export function MainClinic({clinicuuid}){
  ...
  <div className="col-span-12 md:col-span-2">
   ...
   <div
  class="flex flex-col bg-white border theme-border shadow-2xs rounded-xl p-4 md:p-5 dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400
                md:sticky md:top-20">

  <h4 class="text-lg font-semibold mb-3 text-gray-800 dark:text-neutral-200">
  ...
  <ul class="space-y-2">
    ...
    <li
      class="border theme-border rounded-2xl p-2 w-full flex items-center gap-2 sm:gap-3 text-sm sm:text-base">

      <div class="w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-green-100 flex justify-center items-center">
        <svg xmlns="http://www.w3.org/2000/svg" class="w-3 h-3 sm:w-4 sm:h-4 text-green-700" viewBox="0 0 24 24" fill="currentColor">
    ...
    <li
      ...
      <div class="w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-red-100 flex justify-center items-center">
        <svg xmlns="http://www.w3.org/2000/svg" class="w-3 h-3 sm:w-4 sm:h-4 text-red-600" viewBox="0 0 24 24" fill="currentColor">
