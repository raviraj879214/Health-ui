...
export function ListingSuccess({ session_id }) {
  ...
  useEffect(() => {
    ...
    // router.replace("/partner/clinic-boost-package");


    window.history.replaceState({}, "", "/partner/clinic-boost-package");
  ...
  const sendSessionId = async () => {
    try {
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_NODEJS_URL}/v1/api/manage-clinic-boost-package/insert-clinic-listing`,
        {
          method: "POST",
    ...
    <>
      <div className="flex items-center justify-center min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
        <div className="w-full max-w-2xl p-12 mx-4 text-center bg-white shadow-lg rounded-xl">
          ...
          <div className="mt-12">
            <a
              href="/partner/clinic-boost-package"
