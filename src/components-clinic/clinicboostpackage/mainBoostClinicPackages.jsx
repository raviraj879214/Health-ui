...
import {Listofactivecliniclisting} from "../clinicboostpackage/listofactivecliniclisting";
...
export function MainBoostClinicPackages(){
     ...
     const [degree,setDegree]= useState("");
      ...
      useEffect(() => {
            ...
            const fetchClinicPackages =async ()=>{
                debugger;
                     const res = await fetch(`${process.env.NEXT_PUBLIC_NODEJS_URL}/v1/api/manage-clinic-boost-package/get-clinic-listing`,{
                         method : "Get",
      ...
      const fetchBoostPackages = async () => {
        debugger;
             const res = await fetch(`${process.env.NEXT_PUBLIC_NODEJS_URL}/v1/api/manage-clinic-boost-package/get-boost-packages`, {
                 method: "Get",
                 headers: clinicHeaders(),
    ...
    try {
      ...
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_NODEJS_URL}/v1/api/payments/create-clinic-listing-session`,
        {
          method: "POST",
    ...
    return(<>
     ...
     <ComponentCard title="List of Packages">
            ...
            <Listofactivecliniclisting></Listofactivecliniclisting>
