        ...
        <div className="card overflow-hidden rounded-thm border border-border flex">
            ...
            <div className="content md:p-5 p-4 flex-auto">
                ...
                <div className="md:mb-6 mb-3">
                    <p className="mb-0">Started From: <span className="text-tertairy font-bold">$299</span></p>
                </div>
                <Link href="/clinics/sdfsd" className="btn btn-secondary md:px-6 md:py-3 px-3 py-1.5 md:text-[1em] text-[0.8em]">View Detail</Link>
            </div>
        </div>
    )
}