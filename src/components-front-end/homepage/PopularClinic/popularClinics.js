    ...
    const [clinics,setClinic] = useState([]);
     ...
     useEffect(()=>{
      ...
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_NODEJS_URL}/v1/api/homepage-banner/get-clinic-list-popular`,
        {
          method: "POST",
          headers: {
  ...
  <div className="md:my-18 my-16">
            <div className="container">
                ...
                <div className="swiper-offet-wrap">
                    <div className="swiper swiper-clinics">
                        <div className="swiper-wrapper">
                            {clinics.map((clinic) => (
                                <div className="swiper-slide" key={clinic.uuid}>
                                    <ProductCardPopular   data={clinic} />
