...
export function MainPatinetQuery({ id, name }) {
 ...
 <div className="flex items-end justify-between w-full mt-4">
                ...
                {(termsCondition == 1 && PatientQueryQuestion.PATIENTTERMSCONDITION == step) && (<>
                  ...
                  {(PatientQueryQuestion.WAHTMATTERMOST === step && whattmattermostid !== ''  ) && (<>
                      <button
                        className="btn btn-primary rounded-4xl bg-blue-400 px-6 py-2 "
                        onClick={() => dispatch(addStep())}
                        disabled={whattmattermostid !== '' ?  false : true}
                        >
                  ...
                  {(PatientQueryQuestion.MEDICALREPORT === step && medicalReportsID !== ''  ) && (<>
                      <button
                        className="btn btn-primary rounded-4xl bg-blue-400 px-6 py-2 "
                        onClick={() => dispatch(addStep())}
                        disabled={medicalReportsID !== '' ?  false : true}
                        >
                  ...
                  {(PatientQueryQuestion.PROCEDURETIME === step && procedureTimeID !== ''  ) && (<>
                      <button
                        className="btn btn-primary rounded-4xl bg-blue-400 px-6 py-2 "
                        onClick={() => dispatch(addStep())}
                        disabled={procedureTimeID !== '' ?  false : true}
                        >
