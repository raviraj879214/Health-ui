...
export function CreateSpecialty(){
    ...
    const onCreate = async (data) => {
        ...
        const res = await fetch(`${process.env.NEXT_PUBLIC_NODEJS_URL}/v1/api/manage-procedure/create-procedure`, {
            method: "Post",
    ...
    const onUpdate = async (data) => {
        ...
        const res = await fetch(`${process.env.NEXT_PUBLIC_NODEJS_URL}/v1/api/manage-procedure/update-procedure`, {
            method: "Put",
            headers: await adminHeaders(),
            body : JSON.stringify(payload)
        });
