...
import {ListSpecialty} from "../managespecialties/listSpecialty";
...
export function CreateSpecialty(){
    ...
    const onCreate = async (data) => {
        ...
        const res = await fetch(`${process.env.NEXT_PUBLIC_NODEJS_URL}/v1/api/manage-specialties/create-specialties`, {
            method: "Post",
        ...
        if (res.ok) {
            ...
            if(result.status === 401){
                toast.error("Specialty already exist",{
    ...
    const onUpdate = async (data) => {
        ...
        const res = await fetch(`${process.env.NEXT_PUBLIC_NODEJS_URL}/v1/api/manage-specialties/update-specialties`, {
            method: "Put",
            headers: await adminHeaders(),
            body : JSON.stringify(payload)
        });
    ...
    return(<>
        ...
        <div className="grid grid-cols-12 gap-4 mt-5">
            <div className="col-span-12 sm:col-span-12 space-y-5 sm:space-y-6">
                <ComponentCard title="List of Specialty " desc="">
