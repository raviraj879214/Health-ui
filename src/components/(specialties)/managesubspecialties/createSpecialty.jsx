...
export function CreateSpecialty(){
    ...
    const onCreate = async (data) => {
        ...
        const res = await fetch(`${process.env.NEXT_PUBLIC_NODEJS_URL}/v1/api/manage-sub-specialties/create-sub-specialties`, {
            method: "Post",
        ...
        if (res.ok) {
            ...
            if(result.status === 401){
                toast.error("Sub Specialty already exist",{
            ...
            toast.success("Sub Specialty created successfully",{
                    position : "bottom-right",
                    autoClose : 3000
            });
            reset();
    ...
    const onUpdate = async (data) => {
        ...
        const res = await fetch(`${process.env.NEXT_PUBLIC_NODEJS_URL}/v1/api/manage-sub-specialties/update-sub-specialties`, {
            method: "Put",
            headers: await adminHeaders(),
            body : JSON.stringify(payload)
        });
        if(res.ok){
            ...
            toast.success("Sub Specialty updated successfully",{
                    position : "bottom-right",
                    autoClose : 3000
            });
            reset();
    ...
    return(<>
                    ...
                    <form onSubmit={handleSubmit(specialtiesid != null ? onUpdate : onCreate)}>
                        <div className="grid grid-cols-12 gap-6">
                             ...
                             <div className="col-span-12 sm:col-span-6">
                                ...
                                {...register("name",
                                    {
                                        required: "Please enter sub specialty name",
                                    })}
        ...
        <div className="grid grid-cols-12 gap-4 mt-5">
            <div className="col-span-12 sm:col-span-12 space-y-5 sm:space-y-6">
                <ComponentCard title="List of Sub Specialty " desc="">
