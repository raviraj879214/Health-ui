...
export function ClinicSubSpecialty({ id }) {
    ...
    const acceptRequested = async(id)=>{
        ...
        const res = await fetch(`${process.env.NEXT_PUBLIC_NODEJS_URL}/v1/api/manage-clinic/accept-clinic-sub-specialty/${id}`,{
            method : "Get",
            headers : await adminHeaders(),
        });
    ...
    useEffect(()=>{
     ...
     const rejectRequested = async(id)=>{
        ...
        const res = await fetch(`${process.env.NEXT_PUBLIC_NODEJS_URL}/v1/api/manage-clinic/reject-clinic-sub-specialty/${id}`,{
            method : "Get",
            headers : await adminHeaders(),
        });
