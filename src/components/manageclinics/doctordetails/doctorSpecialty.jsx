...
export function DoctorSpecialty({ id }) {
    ...
    const fetchSpecialty=async()=>{
        const res = await fetch(`${process.env.NEXT_PUBLIC_NODEJS_URL}/v1/api/manage-doctor/get-specialty/${id}`,{
            method : "Get",
    ...
    const fetchClinicSpecialty = async () => {
        const res = await fetch(`${process.env.NEXT_PUBLIC_NODEJS_URL}/v1/api/manage-doctor/get-doctor-specialty/${id}`, {
            method: "Get",
            headers: await adminHeaders()
        });
    ...
    const acceptRequested = async(ids)=>{
            ...
            const res = await fetch(`${process.env.NEXT_PUBLIC_NODEJS_URL}/v1/api/manage-doctor/accept-doctor-specialty/${ids}/${id}`,{
                method : "Get",
                headers : await adminHeaders(),
            });
    ...
    useEffect(()=>{
     ...
     const rejectRequested = async(ids)=>{
        ...
        const res = await fetch(`${process.env.NEXT_PUBLIC_NODEJS_URL}/v1/api/manage-doctor/reject-doctor-specialty/${ids}/${id}`,{
            method : "Get",
            headers : await adminHeaders(),
        });
    ...
    const assignSpecialty=async(assignid)=>{
       setButton(true);
        ...
        const res = await fetch(`${process.env.NEXT_PUBLIC_NODEJS_URL}/v1/api/manage-doctor/assign-doctor-specialty`,{
            method : "Post",
            headers: await adminHeaders(),
            body: JSON.stringify({
                "assignid" : assignid,
    ...
    setButton(true);
         ...
         const res = await fetch(`${process.env.NEXT_PUBLIC_NODEJS_URL}/v1/api/manage-doctor/unassign-doctor-specialty`,{
            method : "Post",
            headers: await adminHeaders(),
            body: JSON.stringify({
