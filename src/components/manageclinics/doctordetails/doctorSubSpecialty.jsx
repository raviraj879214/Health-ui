...
export function DoctorSubSpecialty({ id }) {
    ...
    const fetchSpecialty=async()=>{
        ...
        const res = await fetch(`${process.env.NEXT_PUBLIC_NODEJS_URL}/v1/api/manage-doctor/get-sub-specialty/${id}`,{
            method : "Get",
    ...
    const fetchClinicSpecialty = async () => {
        debugger;
        const res = await fetch(`${process.env.NEXT_PUBLIC_NODEJS_URL}/v1/api/manage-doctor/get-doctor-sub-specialty/${id}`, {
            method: "Get",
            headers: await adminHeaders()
        });
    ...
    const acceptRequested = async(ids)=>{
        ...
        const res = await fetch(`${process.env.NEXT_PUBLIC_NODEJS_URL}/v1/api/manage-doctor/accept-doctor-sub-specialty/${ids}/${id}`,{
            method : "Get",
            headers : await adminHeaders(),
        });
    ...
    useEffect(()=>{
     ...
     const rejectRequested = async(ids)=>{
        ...
        const res = await fetch(`${process.env.NEXT_PUBLIC_NODEJS_URL}/v1/api/manage-doctor/reject-doctor-sub-specialty/${ids}/${id}`,{
            method : "Get",
            headers : await adminHeaders(),
        });
    ...
    const assignSpecialty=async(assignid)=>{
       setButton(true);
        ...
        const res = await fetch(`${process.env.NEXT_PUBLIC_NODEJS_URL}/v1/api/manage-doctor/assign-doctor-sub-specialty`,{
            method : "Post",
            headers: await adminHeaders(),
            body: JSON.stringify({
                "assignid" : assignid,
    ...
    setButton(true);
         ...
         const res = await fetch(`${process.env.NEXT_PUBLIC_NODEJS_URL}/v1/api/manage-doctor/unassign-doctor-sub-specialty`,{
            method : "Post",
            headers: await adminHeaders(),
            body: JSON.stringify({
                                ...
                                <ul className="p-2 text-sm text-body font-medium mt-1 h-[400px] overflow-auto">
                                    ...
                                    {specialty.map((item)=>(
                                      <li key={item.id} className="flex items-center justify-between p-2 border border-neutral-100 rounded-base transition-colors hover:bg-brand-soft">
                                            ...
                                            {item.doctors?.some(clinic => clinic.doctorUuid === id) ? (
                                                <button
