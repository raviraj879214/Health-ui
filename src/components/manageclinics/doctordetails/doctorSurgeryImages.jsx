...
export function DoctorSurgeryImages({id}){
    ...
    const fetchSurgeryImages = async()=>{
        debugger;
        const res = await fetch(`${process.env.NEXT_PUBLIC_NODEJS_URL}/v1/api/manage-doctor/get-doctor-surgery-images/${id}`,{
            method : "Get",
                      ...
                      <div className="p-4 md:p-5">
                        ...
                        <div className="max-h-[400px] overflow-y-auto">
                           {surgeryimage.length === 0 && (
                                <p className="text-gray-500 dark:text-gray-400 text-center">No surgery images available.</p>
                            )}
