...
import {PackageSpecialty} from "./packageSpecialty";
import {PackageSubSpecialty} from "./packageSubSpecialty";
import {PackageTreatment} from "./packageTreatment";
import {PackageProcedure} from "./packageProcedure";
        ...
        <ComponentCard>
            ...
            <div className="bg-white ">
                <div className="">
                                ...
                                <div className="grid gap-6 p-6 md:grid-cols-2">
                                    ...
                                    <div className="rounded-2xl bg-gradient-to-br from-indigo-50 to-white p-5 shadow-sm">
                                        ...
                                        <p className="mt-2 text-sm leading-relaxed text-gray-600">
                                            {packages?.clinic?.cep && <>{packages?.clinic?.cep} - </>}
                                            {packages?.clinic?.street}
                                            {packages?.clinic?.complement && <> , {packages?.clinic?.complement}</>}
                                            {packages?.clinic?.neighborhood && <> - {packages?.clinic?.neighborhood}</>}
                                            {packages?.clinic?.citycep && <> - {packages?.clinic?.citycep}</>}
                                        </p>
                                    </div>
                    ...
                    <br></br>
                    <PackageSpecialty id={id} />
                     <br></br>
                    <PackageSubSpecialty id={id} />
                     <br></br>
                    <PackageTreatment id={id} />
                     <br></br>
                    <PackageProcedure id={id} />
                     <br></br>
                    <PackageStatus id={id} />
